...
import org.zwobble.hod.compiler.*
...
fun loadModuleSet(moduleSet: ModuleSet): Image {
    return Image(moduleSet.modules.associate { module ->
        val instructions = when (module) {
            is Module.Hod -> loadModule(module)
...
private fun loadModule(module: Module.Hod): PersistentList<Instruction> {
    val loader = Loader(
...
internal class Loader(
    ...
    internal fun loadModule(module: Module.Hod): PersistentList<Instruction> {
